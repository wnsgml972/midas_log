...
* `R1→R2` 또는 `V200→V300` 등으로의 큰 변화가 있을 경우, 위 프로젝트폴더 전체를 복사해서 작업하는 것을 추천한다. 즉 `V200R2`버전인 경우, `MIDAS_Secret_V200_R2_KR` 폴더를 새로 만들어 작업한다. 복사한 ism 파일 및 동 경로의 폴더명도 변경해주자
